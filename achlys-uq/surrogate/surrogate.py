...
source = ColumnDataSource(
    data=dict(
        grid=grid, mean=mean, lower=mean - 1.96 * stdev, upper=mean + 1.96 * stdev
    )
)
...
plot.line(
    "grid", "mean", source=source, line_width=3, line_color="black", line_alpha=0.8
)
plot.line(
    "grid",
    "lower",
